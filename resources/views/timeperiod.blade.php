...
@section('title','按时间周期查看')
@section('content')
<div id="vue">
	<div>
		&nbsp;&nbsp;<input id="begin" type="date" value="2017-01-01"/>--<input id="end" type="date"/>
		<button type="button" class="btn btn-info" v-on:click="find">查找</button><br /><br />
	</div>
	<div class="panel panel-default">
			<div class="panel-heading">按时间周期查看</div>
...
//		    	mode = setmode.id.toString();
		        $.ajax({						
                        type: "post",
                        url: "/getList",
                        data:{mode:"timeperiod",begin:$("#begin").val(),end:$("#end").val(),page:_self.page},
                        error:function(){
                        	alert('失败！')
                        },
